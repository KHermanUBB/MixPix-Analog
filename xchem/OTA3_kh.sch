...
C {devices/ipin.sym} 90 -510 0 0 {name=p3 lab=OUT}
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 690 -480 0 0 {name=M6
L=2
W=40
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 690 -250 0 0 {name=M5
L=0.5
W=0.859
nf=1
mult=1
...
C {devices/capa.sym} 650 -390 1 0 {name=C1
m=1
value=195f
footprint=1206
